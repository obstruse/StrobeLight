...
void httpWifiTaskCreate() {
  ...
  // handleConfig will cause config page to pop on AP access, or map to generate204()...
  server.on ( "/generate_204", handleConfig );  // Android, check for captive portal, internet access
  server.on ( "/fwlink", handleConfig );       // Microsoft, check for captive portal, internet access
